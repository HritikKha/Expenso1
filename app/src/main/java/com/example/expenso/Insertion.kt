...
class Insertion : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLocation=findViewById(R.id.locationButtonInsertion)
        ...
        val categories = listOf("Select Category", "Salary", "Award", "Gift", "Investment Return",  "Other")
        val spinner = findViewById<Spinner>(R.id.categorySpinnerInsertion)
